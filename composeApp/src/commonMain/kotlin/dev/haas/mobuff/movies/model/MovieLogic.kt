...
object MovieLogic {
    ...
    suspend fun getMovieList(language: String = "te", page: Int = 1): MovieResponse {
        val movieList = httpClient.get("https://api.themoviedb.org/3/discover/movie") {
    ...
    suspend fun searchMovie(query: String, language: String, page: Int): MovieResponse {
        val movie = httpClient.get("https://api.themoviedb.org/3/search/movie?include_adult=false") {
